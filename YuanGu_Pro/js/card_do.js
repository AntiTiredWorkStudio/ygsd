$(document).ready(function(){
   ...
   $('#xin2').click(function(){
    ...
    $('#xin3').click(function(){
	 ...
	 $('#xin4').click(function(){
		$("#xin_nr4").slideToggle("slow");
		$('#xin_nn4').toggleClass("change");
		return false;
   });
	  $('#xin5').click(function(){
		$("#xin_nr5").slideToggle("slow");
		$('#xin_nn5').toggleClass("change");
		return false;
   });
	   $('#xin6').click(function(){
		$("#xin_nr6").slideToggle("slow");
		$('#xin_nn6').toggleClass("change");
		return false;
   });
	    $('#xin7').click(function(){
		$("#xin_nr7").slideToggle("slow");
		$('#xin_nn7').toggleClass("change");
		return false;
   });
