...
<html>	
	...
	<body>
		...
		<div class="slider clearfix" >
    	   <ul>
    		<li>
    			<img src="sources/IMG_0725.JPG">
    		    <div>本店盛大开业</div>
    		</li>
    		<li><img src="sources/IMG_0726.JPG">
    		    <div>本店开张，招收各地有志之士</div>
    		</li>
    		<li>
    			<img src="sources/IMG_0727.JPG">
    			<div>到店享受即刻8折优惠</div>
    		</li>
    		<li>
    			<img src="sources/IMG_0728.JPG">
    		    <div>high到爆的夜场生活</div>
    		</li>
    	</ul>
        </div>
        ...
        <div class="footer ">
        	<div class="top">
	        	<ul>
	        		...
	        		<li class="active"><a href="<?php echo _URL('sho');?>"><div><img src="img/li_3.png"></div><div><span style="font-size:12px; color:#FFF;">&nbsp商城</span></div></a></li>
